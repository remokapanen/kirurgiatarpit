...
![](images/lymfödeema.png)
![](images/lymfedeemakaavio.png)
  </div>
</div>

## Ruokatorvisyöpä, mikä on totta insidenssin suhteen

- a. Adenokarsinooma on yleistynyt ja levyepiteelikarsinooma yleistynyt
- b. Adenokarsinooma on vähentynyt ja levyepiteelikarsinooma vähentynyt
- c. Levyepiteelikarsinooma on yleistynyt ja adenokarsinooma vähentynyt
- d. Levyepiteelikarsinooma on vähentynyt ja adenokarsinooma yleistynyt 
...
![](images/ruokatorvisyöpäinsidenssit.png)
  </div>
</div>

## Abdominal plastia: lihavuus pannikulektomia
...
## Mikä on penissyövän epätyypillisin kasvupaikka? 
...
## Uroteelisyöpä – mikä parhain kuvantamismuoto?
...
## Latissimus dorsi -implantaatio komplikaatio
...
![DIEP](images/diep.png)
![LD-kieleke](images/ld.png)
![Siirotus](images/siirotus.png)
...
![](images/tromboflebiittialgoritmi.png)

## Kilpirauhasen kysta yli 3 cm, painaa – mikä hoitomuoto?
...
## Mikä on yleisin kilpirauhaskarsinooman tyyppi?
...
![](images/barronisaatio.png)
![](images/hemorrhoids.png)
...
_Leikkauksen edellytyksenä on myös, ettei potilaalla ole päihdeongelmaa!_
...
![](images/lihavuuskirurgiakriteerit.png)
![](images/lihavuusleikkaustekniikat.png)
![](images/sleevepass.png)

## Crohnin tauti ja leikkaus eli mikä on tehty
...
## Anteriorinen resektio tehty, epäilet saumalekaasia. Mikä kuvantamistutkimus paras?
...
![](images/anteriorinenresektio.png)
  </div>
</div>
...
## Hb 82, melena, ei verioksennusta. Missä vuoto todennäköisimmin? 
...
![](images/givuodottaulukko.png)
  </div>
</div>

## Potilastapaus

_Kysymys todennäköisesti ollut jo 2022, mutta wikissä kirjoitettu vain aihe ylös. Tämä potilastapausteksti on vuoden 2024 tentistä, jossa todennäköisesti on taas kysytty sama kysymys kuin aiemmin._
...
- a. pneumonia ja laajakirjoinen ab, CPAP
- b. empyeema, pleuradreeni, laajakirjoinen ab
- c. joku (ei wikissä)
...
Jos pleura ei tyhjene dreenillä -> heti leikkaus. Samoin jos mikrobilääkityksellä ja dreneerauksella tauti ei osoita paranemisen merkkejä, niin leikkaukseen tulisi edetä viimeistään viikossa. Ensisijaisesti kirurginen hoito tulisi toteuttaa tähystysleikkauksena (pidemmälle edennyt avoleikkauksena). Leikkaushoidon tavoitteena on tyhjentää märkä ja kuoria paksu fibriini keuhkon päältä (eli dekortikaatio)– > jos keuhko ei laajene, tyhjä tila täyttyy herkästi mädällä. Empyeemapotilaista noin puolet tarvitsee kirurgista hoitoa.
  </div>
</div>
...
![](images/munuaistuumorialgoritmi.png)

## Vatsa-aorttan aneurysmat – miten oireilee? +hoito
...
- Hoitovaihtoehdot: 
  - Suonensisäisen stenttiproteesin (EVAR, endovascular aneurysm repair) asentaminen on nykyään ensisijainen AAA:n hoito, sillä sen aiheuttama välitön riski potilaalle on pienempi, erityisesti revenneen AAA:n osalta
...
![](images/gskopiaindikaatiot.png)

## Mahahaava ja maligniteetit
...
## Milloin sarkoomaa kannattaa epäillä 
...
## Sarkoomaepäily, mitä tehdään tk:ssa?

- a. stanssibiopsia
- b. poistan koko muutoksen PAD-näytteeksi
- c. sarkoomaepäilyssä ei koskaan saa ottaa näytettä tk:ssa
- d. joku (ei wikissä)
...
- a. aina lihaksesta peräisin
- b. yleensä perinnöllinen
- c. yleensä traumaperäinen
- d. yleensä syvällä
...
## Lymfakierron ongelmien etiologia
...
![](images/ercp.png)
![](images/ercpkuvaus.png)

## Laskimoiden termoablaatio
...
## Laskimovajaatoiminnan hoitoindikaatiot
...
**Kajoavan hoidon indikaatiot ovat seuraavat: komplisoitunut tauti (C4-C6), toistuvat pintalaskimotukokset/laaja pintalaskimotukos, vuotavat suonikohjut tai merkittävää haittaa aiheuttava komplisoitumaton tauti (kunhan BMI <35).** Merkittävä haitta tarkoittaa haittaluokka 2-3 (potilas ei pysty työskentelemään ilman kompressiohoitoa tai ei pysty työskentelemään siitä huolimatta). 

![](images/pintalaskimovajaatoimintaalgoritmi.png)
![](images/laskimovajaatoimintahaittaluokka.png)
  </div>
</div>
...
## Haimatulehduksen vaikeus, mikä korreloi?

- a. Amylaasi
- b. Haimaperäinen amylaasi
- c. Lipaasi
- d. CRP
...
![](images/apvaikeusaste.png)
  </div>
</div>

## Mikä leikkaus tehdään, kun potilaalla todetaan divertikkeliperforaatio ja fekaaliperitoniitti?
...
## Raskaaksi haluava nainen ja hyperparatyreoosi
...
![](images/typesofhernias.png)

## Komplisoitunut divertikuliitti. Aloitetaanko ab ja myöhemmin kolonoskopia?

- a. Ab kyllä, kolonoskopia ei
- b. Ab ei, kolonoskopia kyllä
- c. Ab kyllä, kolonoskopia kyllä
- d. Kumpaakaan ei tarvita
...
## Lap.cholen jälkeen 3pop huonovointinen mies, uä:llä sapen lähellä nestettä, radiologin mukaan sappea. Miten hoidetaan ja mikä todnäk aiheuttaja? 
...
## Potilas laihtunut 10kg 3kk aikana ja ikterus. Tt:ssä haimasyöpä. Mikä syöpä todennäköisimmin? 
...
## Potilas 40v nainen oksentanut punaista verta kahvikupillisen. Sama toistuu päivystyksessä. Hb 144 ja tilanne nyt stabiili. Mitä teet? 

- a. Kotiin
- b. Sairaalaan + PPI + ruoka sallittu
- c. Sairaalaan + PPI x2 + ravinnotta
- d. Kotiin + lähipäivinä gastroskopia
...
## Potilaalla haiman adenokarsinooma. Nyt päivystykseen keltaisena ja todetaan sappistaasi. Mikä palliatiivinen tmp? 
...
![](images/haimasyöpäsappistentti.png)
  </div>
</div>

## Mikä on virtsarakkosyövän tärkein riskitekijä? 
...
## Reumaatikolla sääressä laskimoverta vuotava haava, antikoagulaatio. Mitä teet? 
...
## 25v nainen, hypotyreoosi, rinnasta vaaleaa erittävää nestettä. 
...
![](images/rintaeritys.png)

## Mitä tubulaarinen rinta tarkoittaa? 
...
![](images/tubulaarinen.png)
![](images/tubulaarinenkorjattu.png)
  </div>
</div>

## Rintojen pienennysleikkaus, mitä laitat lähetteeseen?
...
![](images/pienennysleikkauslähete.png)

## Brickerin avanne on:

- a. suolirakko
- b. kontinentti avanne
- c. valuva avanne
...
![](images/bricker.png)
![](images/studer.png)
![](images/katetroitavakontinentti.png)
  </div>
</div>
...
![](images/martorellileo.png)

## Akuutti alaraajaiskemia mikä tärkein aiheuttaja? 
...
![](images/acuteonchronic.png)
  </div>
</div>

## Akuutti alaraajaiskemia hoito
...
## Kriittisen kroonisen alaraajaiskemian oire on? 

- a) leposärky 
- b) katkokävely 
- c) lateraalisesti indusoituva kipu erityisesti lonkan fleksiossa 
- d) joku (ei wikissä)
...
Kriittinen iskemia (CLI/CLTI) viittaa krooniseen raajaa uhkaavaan iskemiaan. Keskeisimmät oireet ja löydökset ovat lepokipu ja/tai kudosvaurio (haava tai kuolio), jonka on todettu johtuvan alentuneesta verenkierrosta (eli siis >2vk parantumaton valtimohaava tai lepo kipu + ABI < 0,4 tai nilkkapaine alle 50 mmHg tai varvaspaine alle 30 mmHg). 
...
## Peräaukon fissuura ensilinjan hoito suolen toiminnan normaalistamisen jälkeen?
...
Kroonista haavaumaa hoidetaan vähentämällä sulkijalihaksen tonusta ensisijaisesti voiteilla (nitraaattivoiteet tai kalsiuminestäjävoiteet) tai mahdollisesti botuliinitoksiinipistoksella tai tarpeen mukaan kirurgisella hoidolla (sfinkterotomia)
...
- Ex tempore -kalsiuminestäjävoiteiden (diltiatseemi tai nifedipiini) etu on, että ne eivät aiheuta päänsärkyä kuten nitraattivoide (esim. Rectogesic; on myös kalliimpi). 
  ...
  - Jos potilas ei vastaa voidehoitoon parissa kuukaudessa, tulee hänet lähettä ESH leikkausarvioon (kirurgisessahoidossa katkaistaan sisemmän sulkijalihaksen säikeitä (sfinkterotomia). Itse fissuuraan ei tarvitse kajota.) 
...
1) Akuutissa vaiheessa (6-8vk) hoida taustatekijät ja kipu (puuduttavat voiteet). Istumakylpyjä voi ehdottaa. Vaikeassa tapauksessa voi aloittaa diltiatseemivoiteen heti. 
2) Haavan kroonistuessa ensisijaisesti aloitetaan voidehoito (ensisijaisesti diltiatseemi). Jos potilas ei vastaa voidehoitoon 6-8 viikossa, tulee hänet lähettä erikoissairaanhoitoon leikkausarvioon. Usein tehdään ensiksi botuliinipistoshoitokokeilu, mutta tarvittaessa edetään lateraaliseen sfinkterotomiaan. 
3) Potilas tulee mahdollisesti lähettää ESH myös, jos todetaan epätyypillisesti sijaitseva (lateraalinen) anaalifissuura epäiltäessä Crohnin tautia tai todetaan poikkeuksellisen näköinen haavauma, joka herättää epäilyn maligniteetista. 

## Mikä voi aiheuttaa PSA:n nousua? 
...
## Potilaalla ASO-tauti. Oireena laihtuminen ja postbrandiaalinen vatsakipu. Ei halua syödä. Gastroskopia ja kolonoskopia normaalit. Tt:ssä ei tuumoria. Millä tutkimuksella pääset todennäköisimmin diagnoosiin? 
...
## Potilaalla n. 1,5cm palpoituva muutos kilpirauhasessa. Ensilinjan tutkimus?
...
1. -tomia = kirurginen avoleikkaus johonkin elimeen sisälle 
2. -stomia = kirurgisesti uuden reiän luominen (esim. kolostomia, joka on iholle tuotu = tyypillinen paksusuoliavanne)
3. -ektomia = rakenteen poistaminen

![Laparotomia](images/laparotomia.png)
![Laparostomia](images/laparostomia.png)
  </div>
</div>


## Polandin syndrooma: mitä tarkoittaa?
...
![](images/poland.png)
![](images/polandosmosis.png)
  </div>
</div>

## Prostatahyperplasian lääkkeet ja ortostaattinen hypotensio
...
## Spigelin tyrän sijainti 

- a. molemminpuolinen ylävatsa
- b. molemminpuolinen alavatsa 
- c. oikea ylävatsa
- d. vasen alavatsa 
...
## 55v nainen, rinnan punoitus ja kuumotus, ei palpoituvaa resistenssiä. Mikä jatkohoito?
...
## Rintasyövän kolmoisdiagnostiikka
...
## Mihin käytetään Sengstaken-Blakemoren tuubia?
...
![](images/sengstaken.png)
![](images/varixalgoritmi.png)
  </div>
</div>

## Rectuslihasten diastaasi: leikataanko?
...
![](images/rectusdiastaasianatomia.png)
![](images/rectusdiastaasipotilas.png)
  </div>
</div>

## Reduktioplastian yleisin komplikaatio
...
## Kroonisen pankreatiitin diagnostiikka
...
![](images/priapismihoitomahdollisuudet.png)

## Mitä teet ensimmäisenä, jos kaveri saa palovamman kiukaasta?
...
## Melanooma, basaliooma ja levyepiteelikarsinooma (millaiset esiasteet, mitkä näistä metastasoi?)
...
## Mihin sarkoomat tavallisesti metastasoivat? 
...
## Potilaalla suhteettoman kova vatsakipu, vatsa pehmeä ja myötäävä, potilas tuskainen, mitä kuvannat? 
...
## Laskimovajaatoiminnan patofysiologia
...
## Aortta-aneurysman riskitekijät. Mikä ei ole riskitekijä?

- a. naissukupuoli
- b. tupakointi
- c. 1. asteen sukulaisuus
- d. ikä
...
## Okkluusion auskultaatiolöydöksissä suoliäänet
...
## Akuutin vatsan diagnosoimisessa käytettävät kuvantamiskeinot 
...
![](images/akuvatsakuvat.png)

## Barronisaation komplikaatio ei ole
...
## Anteriorinen resektio tarkoittaa 

- a. haiman kaudan poisto
- b. ventrikkeliresektio
- c. peräsuolen typistys
- d. paksusuolen poisto
...
## Infektoituneessa haavassa kuolio, tärkein hoito ensimmäisenä?
...
## Kuinka monta prosenttia rektumsyövistä voidaan havaita tuseeraamalla? 
...
![](images/30pinnaarektum.png)
  </div>
</div>

## Sappilekaasin diagnoosin varmistaminen kolekystektomian jälkeen
